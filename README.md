...
## Capturable Phenomena as Data
Quick summary of capturable data points

1. Emotions and Direction (Perceivable emotion within the body)
...
Meditation does several things (in my own personal experience), it can help you develop a greater sense of open heartedness/positive thinking (metta), it can develop your ability to direct your attention exactly where you want it (concentration practices), and it can help you develop direct awareness of the stream of sensory experiences that are happening in the moment (vipassana), it can also help you become more present and non-reactive to all experiences in the moment (so called "do nothing" practices). Lastly there is self-inquiry, which is the practice of constantly questioning who you are.
...
2. If it is believed to be, then questioning your certainty of whether or not it is true
3. Collecting all of the Thoughts, Emotion, Perceptions, and Body Sensations associated when one believes the Thought is true
4. Collecting all of the Thoughts, Feelings, Perceptions, and Body Sensations associated if you didn't have the ability to believe/have the Thought
5. Creating counter Thoughts (turnarounds AKA Byron Katie), and question whether or not these Thoughts are as true if not truer
6. For each counter Thought, finding Perceptions in life which are examples of the counter Thought being true
7. Entering into the Emotion of the original Thought and asking if you can let go of the Emotion/Thought, would you?
8. Entering into the Emotion of the original Thought and asking if you could let go of the Emotion/Thought, would you?
9. Lastly, asking yourself "When will I let go of this Thought/Emotion"?
...
3. I don't have X thoughts anymore and didn't even realize it!

This is pretty important because if this type of App does work, you know it works because Thoughts/Feelings AREN'T showing up anymore, and if there is nothing to notice, you may not even realize that improvements are being made.

I'm still kicking around the idea for how this would work, at the moment I am thinking the app should have a sort of "Gains" journal, where you can actually log the positive gains you've noticed from doing the practice. By allowing the user to log the positive benefits they've seen from the practice, it will encourage them to continue to use it.
